...
import com.flipkart.poseidon.exception.DataSourceExceptionFactory;
...
public class CompensatingUserDataSource extends AbstractDataSource<UserDataType> {
    ...
    public UserDataType call() throws Exception {
        try {
            ...
            throw DataSourceExceptionFactory.getDataSourceException("Failed to fetch user details due to service failure", failureException);
            ...
            throw DataSourceExceptionFactory.getDataSourceException("Failed to fetch user details", serviceException);
        }
    }
}
